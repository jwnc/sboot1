...
public class LoggerAdvice
{
    ...
    @AfterReturning( "within(com.wnc..*) && @annotation(loggerManage)" )
    ...
    @AfterThrowing( pointcut = "within(com.wnc..*) && @annotation(loggerManage)", throwing = "ex" )
    public void addAfterThrowingLogger( JoinPoint joinPoint,
            LoggerManage loggerManage, Exception ex )
    {
