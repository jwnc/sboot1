...
public class VUSerPageTask extends AbstractPageTask {
	...
	public VUSerPageTask(String apiUrl, UserV userV, boolean b, ActivitySpy activitySpy, Date beginSpyDate) {
	...
	protected void retry() {
		if (!activitySpy.isTaskOver()) {
			...
			activitySpy.errLog(utoken, apiUrl, "不能重试, 因为spy已经结束.", currentProxy);
		}
	}
