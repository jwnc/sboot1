...
public class ActivitySpecifySpy extends ActivitySpy
{
    ...
    {
        Date taskBeginTime = BasicDateUtil.getDateTimeFromString("2018-05-24 10:05:00.000",
    ...
    {
        Date dateTimeFromString = BasicDateUtil.getDateTimeFromString("2018-01-01 00:00:00.000",
            "yyyy-MM-dd HH:mm:ss.SSS");
        List<UserV> list = new ArrayList<>();
        list.add(new UserV("jie-shi-bang-53",
            "https://www.zhihu.com/api/v4/members/jie-shi-bang-53/activities?after_id=1515051401",
            dateTimeFromString));
        // list.add(new UserV("chen-pei-si-13",
        // "https://www.zhihu.com/api/v4/members/chen-pei-si-13/activities", dateTimeFromString));
        return list;
