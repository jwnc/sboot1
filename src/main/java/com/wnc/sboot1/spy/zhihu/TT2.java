...
public class TT2 {
	...
	public static void main(String[] args) throws IOException {
		...
		AbstractPageTask.retryMap.put(GeneralPageTask.class, new HashMap<String, Integer>());
		System.out.println(initAuthorization());
	}

	public static String initAuthorization() {
		if (key != null) {
			return key;
		}
		String content = "";
		...
		while (System.currentTimeMillis() - t < 600 * 1000) {
			GeneralPageTask generalPageTask = new GeneralPageTask("https://www.zhihu.com/people/zengjiaplus/following",
					true);
			generalPageTask.run();
			...
			if (page.getStatusCode() == 200) {
				...
				if (getJs(content) != null) {
					...
					ProxyPool.proxyQueue.remove(generalPageTask.getWrongProxy());
				}
			}
		}
