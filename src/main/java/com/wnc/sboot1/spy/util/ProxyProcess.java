...
public class ProxyProcess
{
    ...
    private static Set<Proxy> cache = Collections.synchronizedSet(new HashSet<Proxy>());
        ...
        throws IOException
    {
        ...
        for (int i = 0; i < fatestProxies.size(); i++ )
        {
            ...
            Proxy p = new Proxy(PatternUtil.getFirstPatternGroup(info, "(.*?):"),
                BasicNumberUtil.getNumber(PatternUtil.getLastPattern(info, "\\d+")),
