...
/*     */
{
    /*     */private static synchronized boolean _$1( String paramString1,
    ...
    /*     */
    {
        ...
        /*     */try
        /*     */ {
            /* 26 */if ( BasicStringUtil.isNotNullString( paramString1,
                    paramString2, paramString3 ) )
            /*     */
            {
                /* 30 */if ( !BasicFileUtil
                        .isExistFolder( str2 = "d:\\temp\\log\\database" ) )
                /*     */
                {
                    /* 32 */str2 = BasicFileUtil.removeLastSplit(
                            System.getProperty( "java.home" ) );
                    /*     */}
                /*     */
                /* 35 */if ( (BasicStringUtil.isNotNullString( str2 ))
                        && (BasicFileUtil.makeDirectory( BasicFileUtil
                                .getMakeFilePath( str2, str3, str4 ) )) )
                /*     */
                {
                    /*     */RandomAccessFile tmp121_118 = new RandomAccessFile(
                            BasicFileUtil.getMakeFilePath( str2, str3, str4,
                                    BasicDateUtil.getCurrentDateString() + "-"
                                            + str5 ),
                            "rw" );
                    /*     */RandomAccessFile localRandomAccessFile;
                    /* 37 */tmp121_118
                            /* 39 */.seek( (localRandomAccessFile = tmp121_118)
                                    /* 39 */.length() );
                    ...
                    /*     */
                    /* 45 */localRandomAccessFile
                            .writeBytes( BasicStringUtil.GBK2ISO( str1 ) );
    ...
    /*     */
    /*     */public static void errorLog( String paramString1,
            String paramString2, String paramString3 )
    /*     */
    {
    ...
    /*     */
    /*     */public static synchronized boolean writeRSMemoryRowLockLog(
    ...
    /*     */
    {
        ...
        /*     */try
        /*     */ {
            /* 112 */if ( BasicStringUtil.isNotNullString( paramString1,
                    paramString2, paramString3 ) )
            /*     */
            {
                /* 116 */if ( !BasicFileUtil
                        .isExistFolder( str2 = "d:\\temp\\log\\database" ) )
                /*     */
                {
                    /* 118 */str2 = BasicFileUtil.removeLastSplit(
                            System.getProperty( "java.home" ) );
                    /*     */}
                /*     */
                ...
                /*     */
                {
                    ...
                    /*     */RandomAccessFile localRandomAccessFile;
                    /* 123 */tmp121_118
                            /* 125 */.seek( (localRandomAccessFile = tmp121_118)
                                    /* 125 */.length() );
    ...
    /*     */
    /*     */public static synchronized boolean writeSQLInjectionLog(
            String paramString1, String paramString2, String paramString3 )
    /*     */
    {
        /* 60 */int i = 0;
        ...
        /*     */try
        /*     */ {
            /* 69 */if ( BasicStringUtil.isNotNullString( paramString1,
                    paramString2, paramString3 ) )
            /*     */
            {
                /* 73 */if ( !BasicFileUtil
                ...
                /*     */
                {
                    /* 75 */str2 = BasicFileUtil.removeLastSplit(
                            System.getProperty( "java.home" ) );
                    /*     */}
                /*     */
                ...
                /*     */
                {
                    ...
                    /*     */RandomAccessFile localRandomAccessFile;
                    /* 80 */tmp121_118
                            /* 82 */.seek( (localRandomAccessFile = tmp121_118)
                                    /* 82 */.length() );
